...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
            ...
            SignupUserDataAccessInterface userDataAccessObject, ClearUserDataAccessInterface clearUserDataAccessInterface) {

        try {
            SignupController signupController = createUserSignupUseCase(viewManagerModel, signupViewModel, loginViewModel, userDataAccessObject);
            ClearController clearController = createClearUseCase(signupViewModel, clearUserDataAccessInterface);
    ...
    private static ClearController createClearUseCase(SignupViewModel signupViewModel, ClearUserDataAccessInterface clearDAO) {
        ClearOutputBoundary clearOutputBoundary = new ClearPresenter(signupViewModel);
        ClearInputBoundary clearInteractor = new ClearInteractor(clearDAO, clearOutputBoundary);
